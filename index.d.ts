 ...
 */
type CinnabarBrickDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CinnabarBrickSlab
 */
type CinnabarBrickSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CinnabarBrickStairs
 */
type CinnabarBrickStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to CinnabarBrickWall
 */
type CinnabarBrickWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
 * States specific to CinnabarDoubleSlab
 */
type CinnabarDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CinnabarSlab
 */
type CinnabarSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CinnabarStairs
 */
type CinnabarStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to CinnabarWall
 */
type CinnabarWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
 ...
 */
type PolishedCinnabarDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PolishedCinnabarSlab
 */
type PolishedCinnabarSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PolishedCinnabarStairs
 */
type PolishedCinnabarStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to PolishedCinnabarWall
 */
type PolishedCinnabarWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
 ...
 */
type PolishedSulfurDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PolishedSulfurSlab
 */
type PolishedSulfurSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PolishedSulfurStairs
 */
type PolishedSulfurStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to PolishedSulfurWall
 */
type PolishedSulfurWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
...
/**
 * States specific to PotentSulfur
 */
type PotentSulfurStates = Pick<BlockStateSuperset, 'potent_sulfur_state'>;
/**
 ...
 */
type SulfurBrickDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to SulfurBrickSlab
 */
type SulfurBrickSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to SulfurBrickStairs
 */
type SulfurBrickStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to SulfurBrickWall
 */
type SulfurBrickWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
 * States specific to SulfurDoubleSlab
 */
type SulfurDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to SulfurSlab
 */
type SulfurSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to SulfurSpike
 */
type SulfurSpikeStates = Pick<BlockStateSuperset, 'dripstone_thickness' | 'hanging'>;
/**
 * States specific to SulfurStairs
 */
type SulfurStairsStates = Pick<BlockStateSuperset, 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to SulfurWall
 */
type SulfurWallStates = Pick<BlockStateSuperset, 'wall_connection_type_east' | 'wall_connection_type_north' | 'wall_connection_type_south' | 'wall_connection_type_west' | 'wall_post_bit'>;
/**
...
type BlockStateMapping = {
    ...
    potent_sulfur: PotentSulfurStates;
    'minecraft:potent_sulfur': PotentSulfurStates;
    ...
    sulfur_spike: SulfurSpikeStates;
    'minecraft:sulfur_spike': SulfurSpikeStates;
